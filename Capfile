...
task :upload_data, :roles => group_name do
    puts "rsync -e 'ssh -i /home/spkaabi/ec2/spkaabi.pem' -vzP data/* ubuntu@ec2-79-125-40-186.eu-west-1.compute.amazonaws.com:#{mount_point}" 
end
...
task :run_macs, :roles => group_name do
  ...
  treatment = "#{mount_point}/CMN066_s_8_export_sorted_nodups.bam"
  control = "#{mount_point}/CMN065_s_7_export_sorted_nodups.bam"
  genome = 'mm'
  bws = [300]
  pvalues = [0.00001]
